...
try {
  ...
  running = start({ steps: plan('sidebar.project.more', 'sidebar.project.settings', 'projectsettings.tab.notifications', 'projectsettings.notifications.edit.assigned', 'notif.recipient.all-watchers', 'notif.save') })
